...
\subsubsection*{APQ8060 (a development board that runs Android)}
...
on our ocal machine. We first run \prog{litmus} as follows:
\begin{verbatim}
% mkdir -p SRC/DRAGON
% litmus -mach dragon -mem direct -st 1 -driver C -o SRC/DRAGON tst-co/@all
\end{verbatim}
...
Notice that the C~sources are dumped into teh pre-existing
directory \texttt{SRC/DRAGON}.
